(function () {
  ...
  // ---------- Benefits (rendered) ----------
  var BENEFITS = [
    { icon: "i-target", title: "Sinais Precisos", text: "Algoritmo com filtros multi-timeframe para entradas de alta probabilidade." },
    { icon: "i-bell", title: "Alertas em Tempo Real", text: "Notificações push, email e sonoras direto no MT4 assim que o setup aparece." },
    { icon: "i-bars", title: "Multi-Ativos", text: "Funciona em Forex, índices, cripto e metais. Qualquer par, qualquer timeframe." },
    { icon: "i-shield", title: "Gestão de Risco", text: "Stop loss e take profit sugeridos automaticamente com base em volatilidade." },
